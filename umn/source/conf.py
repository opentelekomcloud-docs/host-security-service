...
otcdocs_repo_name = 'opentelekomcloud-docs/host-security-service'
# Those variables are required for edit/bug links

# Those variables are needed for indexing into OpenSearch
otcdocs_doc_environment = 'public'
otcdocs_doc_link = '/host-security-service/umn/'
otcdocs_doc_title = 'User Guide'
otcdocs_doc_type = 'umn'
otcdocs_service_category = 'security-services'
otcdocs_service_title = 'Host Security Service'
otcdocs_service_type = 'hss'
...
html_title = "Host Security Service - User Guide"
...
latex_documents = [
    ('index',
     'hss-umn.tex',
    u'Host Security Service - User Guide',
